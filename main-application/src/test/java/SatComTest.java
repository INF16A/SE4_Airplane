...
public class SatComTest {
    ...
    public void conncect() {
        ...
        try {
            ...
            String satellite = "Ares4";
            String frequency = "450Hz";
            boolean connectResult = (boolean)offMethod.invoke(componentPort, new Object[]{satellite}, new Object[]{frequency});
    ...
    public void receive() {
        ...
        try {
            ...
            method2.invoke(componentPort,new Object[]{"Ares3"} );
