...
public class SeatFactory {
    ...
    public static Object buildCrewSeat() {
        ...
        try {
            URL[] urls = {new File(Configuration.instance.commonPathToJavaArchive + Configuration.instance.fileSeparator + "crewseat.jar").toURI().toURL()};
    ...
    public static Object buildTouristSeat() {
        ...
        try {
            URL[] urls = {new File(Configuration.instance.commonPathToJavaArchive + Configuration.instance.fileSeparator + "touristclassseat.jar").toURI().toURL()};
            URLClassLoader urlClassLoader = new URLClassLoader(urls, SeatFactory.class.getClassLoader());
    ...
    public static Object buildBusinessSeat() {
        ...
        try {
            URL[] urls = {new File(Configuration.instance.commonPathToJavaArchive + Configuration.instance.fileSeparator + "businessclassseat.jar").toURI().toURL()};
            URLClassLoader urlClassLoader = new URLClassLoader(urls, SeatFactory.class.getClassLoader());
    ...
    public static Object buildFirstSeat() {
        ...
        try {
            URL[] urls = {new File(Configuration.instance.commonPathToJavaArchive + Configuration.instance.fileSeparator + "firstclassseat.jar").toURI().toURL()};
            URLClassLoader urlClassLoader = new URLClassLoader(urls, SeatFactory.class.getClassLoader());
