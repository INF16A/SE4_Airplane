...
public class FuelTankFactory {
    public static Object build() {
        ...
        try {
            URL[] urls = {new File(Configuration.instance.commonPathToJavaArchive + Configuration.instance.fileSeparator + "fueltank.jar").toURI().toURL()};
            URLClassLoader urlClassLoader = new URLClassLoader(urls, FuelTankFactory.class.getClassLoader());
            Class fuelTankClass = Class.forName("FuelTank", true, urlClassLoader);
