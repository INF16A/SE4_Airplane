...
public class AirConditioningFactory {
    ...
    public static Object build() {
        ...
        try {
            URL[] urls = {new File(Configuration.instance.commonPathToJavaArchive + "/13_airconditioning.jar").toURI().toURL()};

            System.out.println("Path: " + Configuration.instance.commonPathToJavaArchive + "/13_airconditioning.jar");
