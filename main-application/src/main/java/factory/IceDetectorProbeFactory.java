...
public class IceDetectorProbeFactory {
    public static Object build() {
        ...
        try {
            URL[] urls = {new File(Configuration.instance.commonPathToJavaArchive + "/apuoiltank.jar").toURI().toURL()};
            URLClassLoader urlClassLoader = new URLClassLoader(urls, IceDetectorProbeFactory.class.getClassLoader());
            Class iceDetectorProbeClass = Class.forName("APUOilTank", true, urlClassLoader);
